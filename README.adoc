...
* [Gradle 3.x](https://asciidoctor.github.io/asciidoctor-gradle-plugin/development-3.x/user-guide/#_as_external_library)
* [Maven](https://asciidoctor.org/docs/asciidoctor-maven-plugin/#configuration)
